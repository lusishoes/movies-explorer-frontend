  ...
  return (
    ...
    <div className='aboutme__profile'>
      <div className='aboutme__description'>
          ...
          <p className='aboutme__description-subtitle'>Фронтенд-разработчик, 30 лет</p>
          <p className='aboutme__description-text'>Я родился и живу в Саратове, закончил факультет экономики СГУ. 
