        ...
        <div className="burger__container">
          ...
          <ul className="burger__link-elements">
            <li className="burger__link-list">
              <a className={`burger__link ${location.pathname === '/' ? 'burger__link-chosen' : ''}`} href="/" >Главная</a>
            </li>
            <li className="burger__link-list">
              <a className={`burger__link ${location.pathname === '/movies' ? 'burger__link-chosen' : ''}`} href="/movies">Фильмы</a>
              </li>
              <li className="burger__link-list">
              <a className={`burger__link ${location.pathname === '/saved-movies' ? 'burger__link-chosen' : ''}`} href="/saved-movies">Сохранённые фильмы</a>
            </li>
          </ul>
          <div className="burger__account">
            <a href="/profile" className={`burger__account-info ${location.pathname === '/profile' ? 'burger__account-info-choisen' : ''}`}>Аккаунт</a>
